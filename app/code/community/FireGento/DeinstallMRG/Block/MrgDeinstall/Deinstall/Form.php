    ...
    extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            'mage_local_product_abstract', 'checkbox',
            array(
                 'label' => Mage::helper('firegento_deinstallmrg')
                     ->__(
                     'Delete local/Mage/Catalog/Block/Product/Abstract.php'
                 ),
                 'name'  => 'mage_local_product_abstract',
                 'value' => 1
            )
        );

        $fieldset->addField(
            'mage_local_wishlist_abstract', 'checkbox',
            array(
                 'label' => Mage::helper('firegento_deinstallmrg')
                     ->__('Delete local/Mage/Wishlist/Block/Abstract.php'),
                 'name'  => 'mage_local_wishlist_abstract',
                 'value' => 1
            )
        );
        ...
        $fieldset->addField(
            'symmetrics_agreement_note', 'note',
            array(
                 'label' => 'Information',
                 'text'  => Mage::helper('firegento_deinstallmrg')
                     ->__(
        ...
        $fieldset->addField(
            'symmetrics_agreement_remove', 'checkbox',
            array(
                 'label' => Mage::helper('firegento_deinstallmrg')
        ...
        $fieldset->addField(
            'symmetrics_configGerman_note', 'note',
            array(
                 'label' => 'Information',
                 'text'  => Mage::helper('firegento_deinstallmrg')
                     ->__(
        ...
        $fieldset->addField(
            'remove_firegento_deinstallmrg', 'checkbox',
            array(
                 'label' => Mage::helper('firegento_deinstallmrg')
